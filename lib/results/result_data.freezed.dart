...
/// @nodoc
class __$$SuccessCopyWithImpl<T, $Res> extends _$ResultDataCopyWithImpl<T, $Res>
...
/// @nodoc
class __$$FailureCopyWithImpl<T, $Res> extends _$ResultDataCopyWithImpl<T, $Res>
...
class _$Failure<T> implements Failure<T> {
  ...
  @override
  String toString() {
    return 'ResultData<$T>.failure(error: $error)';
  }
